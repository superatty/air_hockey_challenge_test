...
class RemoteVsLocalTournamentAgentWrapper(TournamentAgentWrapper):
    def __init__(self, ip_1, port_1, container_id_1, name_1, log_dir, agent_2):
        self.container_id_1 = container_id_1
    ...
    def __del__(self):
        ...
        with open(os.path.join(self.log_dir, f"out.log"), 'ab') as f:
            for line in client.api.logs(self.container_id_1, stream=True, follow=False):
                f.write(line)
